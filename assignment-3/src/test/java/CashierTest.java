...
class CashierTest {
    ...
    void setup() {
        ...
        this.customer9.getItems().add(new Purchase(this.prod3, 1)); // 9 items

        this.customer2 = new Customer(LocalTime.NOON, "1000AB");
        this.customer2.getItems().add(new Purchase(this.prod2, 2)); // 2 items

        this.customer1 = new Customer(LocalTime.NOON, "1000AB");
        this.customer1.getItems().add(new Purchase(this.prod1, 1)); // 1 item
